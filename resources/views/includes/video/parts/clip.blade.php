<div x-show="tabOpen === 'clip'" x-cloak class="text-primary-300">
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
        @foreach (array_reverse($video->videos['results'] ?? []) as $clip)
            @php
            ...
            <div class="mt-2" x-data="{
                ...
                <button clip="{{ $clip['key'] }}">
                    <div class="relative group">
                        <img src="http://i3.ytimg.com/vi/{{ $clip['key'] }}/hqdefault.jpg" alt="image"
                        ...
                        <span class="hidden group-hover:block px-2 rounded-md position-center bg-primary-900 z-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-accent-400" width="28"
