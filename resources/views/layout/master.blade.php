    ...
    <head>
        ...
        <style>
            ...
            .loader {
                width: 45px;
                aspect-ratio: 1;
                --c1: linear-gradient(90deg, #0000 calc(100%/3), var(--color-accent-400) 0 calc(2*100%/3), #0000 0);
                --c2: linear-gradient(0deg, #0000 calc(100%/3), var(--color-accent-400) 0 calc(2*100%/3), #0000 0);
